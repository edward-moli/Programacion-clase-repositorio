...
namespace programa0903
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            //Dibujamos un serie de lineas
            Point[] puntos =
            {
                new Point(30,45),new Point(110,75),new Point(175,200)
            };
            ...
            Point[] puntos2 =
            {
                new Point(10,25),new Point(50,200),new Point(150,230)
            };
            g.DrawCurve(Pens.Purple, puntos2);

            //Dinujamos un segmento de pie
